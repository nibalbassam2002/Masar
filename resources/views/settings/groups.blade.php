...
<div class="max-w-[1000px] mx-auto px-8 py-10">
    ...
    <header class="mb-12">
        ...
        <p class="text-slate-500 mt-2 font-medium italic">Create and manage your own team categories for your projects.</p>
    </header>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                ...
                <form action="{{ route('settings.groups.store') }}" method="POST" class="space-y-6">
                    ...
                    <button type="submit" class="w-full btn-primary !py-4 justify-center shadow-cyan-100">Add to My List</button>
                </form>
            </div>
        </div>
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] overflow-hidden">
                <table class="w-full text-left border-collapse">
                    <thead class="bg-slate-50/50 border-b border-slate-100">
                        <tr>
                            <th class="py-5 px-8 text-[10px] font-black text-slate-400 uppercase tracking-widest">Group Name (Created by Me)</th>
                            <th class="py-5 px-8 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Action</th>
                        </tr>
                    </thead>
                        ...
                        <tr class="group hover:bg-slate-50/30 transition-all">
                            <td class="py-5 px-8">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-bold text-slate-700 capitalize">{{ $group->name }}</span>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" class="py-20 text-center">
                                <div class="opacity-20 flex flex-col items-center">
                                    ...
                                    <p class="text-[10px] font-black uppercase tracking-widest">No Personal Groups</p>
                                    <p class="text-[9px] font-medium mt-1 uppercase">Any groups you add will appear here.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
